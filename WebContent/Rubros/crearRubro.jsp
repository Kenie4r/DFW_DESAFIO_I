...
<div class="input-group mb-3">
  ...
  <input type="text" class="form-control" name="nombre" placeholder="Escribe aquí..." aria-describedby="basic-addon1">
</div>

<div class="input-group mb-3">
  <span class="input-group-text" id="basic-addon1">Descripción:</span>
  <textarea class="form-control" name="descripcion" placeholder="Escribe aquí..." aria-describedby="basic-addon1" rows="5" style="border: 1px #6b7280 solid; border-radius: 0px;" ></textarea>
</div>
