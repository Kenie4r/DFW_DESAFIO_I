...
<title>Nuevo rubro - La Cuponera</title>
</head>
...
<h1 class="text-left" style="font-size: 35px"><b>Añadir nuevo rubro</b></h1>
<br>
...
<div class="flex">
  ...
  blue-500 block flex-1 min-w-0 w-full text-sm border-gray-300 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" type="text" name="nombre" placeholder="Escribe aquí...">
</div>
