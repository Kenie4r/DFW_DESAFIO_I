...
<body>
	...
	<div style="margin-left: 5vw; margin-right: 20vw; ">
		<h1 class="text-left" style="font-size: 35px"><b>Editar empresa</b></h1>
		<br>
                ...
                <form role="form" action="${pageContext.request.contextPath}/empresas.do" method="POST">
 					...
 					<div class="flex">
                        ...
                        <input 
                            ...
                            type="text" readonly name="codigo" id="codigo"value="${empresa.getIdEmpresa()}" placeholder="Ingresa el codigo de la Empresa">
                    </div>  
                    <br>
                    <div class="flex">
                        <span 
                        ...
                        <input
                            class="rounded-none rounded-r-lg bg-gray-50 border border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm border-gray-300 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                            type="text" class="form-control" name="nombre" id="nombre" value="${empresa.getNombreEmpresa()}" placeholder="Ingresa el nombre de la Empresa">                    
                    </div>       
                    <br>
                    <div class="flex">
                        <span 
                        ...
                        <input 
                            class="rounded-none rounded-r-lg bg-gray-50 border border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm border-gray-300 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                            type="text" class="form-control" name="ubicacion" id="ubicacion" value="${empresa.getUbicacion()}" placeholder="Ingresa la ubicacion de la Empresa">                            
                    </div>                                                   				                    				
                    <br>
                    <div class="flex">
                        <span 
                        ...
                        <input
                            class="rounded-none rounded-r-lg bg-gray-50 border border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm border-gray-300 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                            type="text" class="form-control" name="contacto" id="contacto"  value="${empresa.getContacto()}" placeholder="Ingresa el nombre de contacto de la Empresa">
                    </div>
                    <br>
                    <div class="flex">
                        <span 
                        ...
                        <input 
                            class="rounded-none rounded-r-lg bg-gray-50 border border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm border-gray-300 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                            type="text" class="form-control" name="telefono" id="telefono" value="${empresa.getTelefono()}" placeholder="Ingresa el telefono de la Empresa">                                            
                    </div>                  					
                    <br>
                    <div class="flex">
                        <span 
                        ...
                        <input 
                            class="rounded-none rounded-r-lg bg-gray-50 border border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm border-gray-300 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                            type="text" class="form-control" name="correo" id="correo" value="${empresa.getCorreo()}" placeholder="Ingresa el correo de la Empresa">
                    </div>
                    <br>
                    <div class="flex">
                        <span 
                        ...
                        <input 
                            class="rounded-none rounded-r-lg bg-gray-50 border border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm border-gray-300 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            type="number" step="0.1" min="0" class="form-control" name="ganancias" id="ganancias" value="${empresa.getPorcentajeGanancias()}" placeholder="Ingresa el porcentaje de Ganancias de la Empresa">                                                    
                   	</div>   
                   	<br>
					<div class="flex">
					    <span
