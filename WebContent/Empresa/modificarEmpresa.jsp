...
<div class="bg-white p-10 rounded-lg shadow md:w-3/4 mx-auto lg:w-1/2">
    <form action="${pageContext.request.contextPath}/EmpresaController">
        ...
        <div class="mb-5">
            ...
            <input required type="text" id="name" name="name" value="${requestScope.nombre }" placeholder="Nombre del rol." class="border border-gray-300 shadow p-3 w-full rounded mb-">
        </div>
          <div class="mb-5">
            <label for="name" class="block mb-2 font-bold text-gray-600">Ubicacion del Empresa</label>
            <input required type="text" id="ubicacion" name="ubicacion"value="${requestScope.ubicacion }" placeholder="Ubicacion del Empresa" class="border border-gray-300 shadow p-3 w-full rounded mb-">
        </div>
            <div class="mb-5">
            <label for="name" class="block mb-2 font-bold text-gray-600">Porcentaje de ganancia</label>
            <input required type="number" id="Porcentaje" value="${requestScope.porcentaje }" name="Porcentaje" placeholder="Porcentaje" class="border border-gray-300 shadow p-3 w-full rounded mb-">
        </div>
         </div>
            <div class="mb-5">
